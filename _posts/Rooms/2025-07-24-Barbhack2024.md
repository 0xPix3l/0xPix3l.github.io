...
> I tried `aaaaaaaaaaaaaaGOTHAMCITY` string just to  to satisfy my curiosity, would it work now with the file in the correct path?
I tried to input that 24 char string and it worked, but it still reads the 5-char string `pix3l` from the `key.txt`.
