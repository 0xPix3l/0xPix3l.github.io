...
classes: wide
header:
  teaser: /assets/images/CTFs/Cicada/background.png
  overlay_image: /assets/images/CTFs/Cicada/background.png
  overlay_filter: 0.8
...
![image](/assets/images/CTFs/Cicada/smb1.png)

HR share was public so I connected to it and found `Notice from HR.txt`
![image](/assets/images/CTFs/Cicada/smb2.png)

After downloading and reading it I had a Password:
![image](/assets/images/CTFs/Cicada/backup_script.png)
...
![image](/assets/images/CTFs/Cicada/kerbrute.png)
...
![image](/assets/images/CTFs/Cicada/rid_enum.png)
...
![image](/assets/images/CTFs/Cicada/user-pass_hit.png)
...
![image](/assets/images/CTFs/Cicada/mitigation.png)
...
![image](/assets/images/CTFs/Cicada/admin_hash.png)


WINRMing using the admin hash to get the root flag
![image](/assets/images/CTFs/Cicada/admin_pass.png)
