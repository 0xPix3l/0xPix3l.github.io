...
permalink: /Rooms/HTB-Cicada/
date: 2024-10-13
categories: [HackTheBox, Active Directory, LDAP, SMB]
...
classes: wide
header:
  teaser: /assets/images/Rooms/Cicada/background.png
  overlay_image: /assets/images/Rooms/Cicada/background.png
  overlay_filter: 0.8
...
![image](/assets/images/Rooms/Cicada/smb1.png)

HR share was public so I connected to it and found `Notice from HR.txt`
![image](/assets/images/Rooms/Cicada/smb2.png)

After downloading and reading it I had a Password:
![image](/assets/images/Rooms/Cicada/backup_script.png)
...
![image](/assets/images/Rooms/Cicada/kerbrute.png)
...
![image](/assets/images/Rooms/Cicada/rid_enum.png)
...
![image](/assets/images/Rooms/Cicada/user-pass_hit.png)
...
- Limit SMB access for unauthorized users
- Use group policies to restrict SID enumeration by untrusted users.
![image](/assets/images/Rooms/Cicada/mitigation.png)
...
![image](/assets/images/Rooms/Cicada/admin_hash.png)


WINRMing using the admin hash to get the root flag
![image](/assets/images/Rooms/Cicada/admin_pass.png)
